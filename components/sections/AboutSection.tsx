...
const points = [
  'Lisanslı ve sertifikalı atık yönetim hizmetleri',
  'Türkiye genelinde geniş operasyonel ağ',
  'Deneyimli çevre mühendisleri kadrosu',
  'Sıfır atık politikasına tam uyum desteği',
];
    ...
    <section className="py-24 bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <SectionLabel className="mb-3 block">Hakkımızda</SectionLabel>
            <h2 className="font-heading text-4xl font-semibold text-text-main mb-6 leading-tight">
              Türkiye&apos;nin Güvenilir<br />
              <span className="text-primary">Atık Yönetimi</span> Ortağı
            </h2>
            <p className="font-body text-base text-text-main/70 leading-relaxed mb-6">
              ECOREN; 10 yılı aşkın deneyimiyle Türkiye&apos;nin önde gelen atık yönetimi danışmanlık ve mühendislik firmalarından biridir. Tehlikeli ve tehlikesiz atıkların geri kazanımı, bertarafı, taşınması ve depolanması başta olmak üzere, çevre mevzuatına tam uyum sağlayan entegre çözümler sunmaktayız.
            </p>
            <p className="font-body text-base text-text-main/70 leading-relaxed mb-8">
              Sıfır Atık felsefesi ve Döngüsel Ekonomi ilkeleri doğrultusunda hareket eden firmamız; sanayi kuruluşları, belediyeler ve kamu kurumlarına yönelik kapsamlı hizmet portföyüyle sürdürülebilir bir gelecek inşa etmeye devam etmektedir.
            </p>
            ...
            <div className="relative">
              <div className="w-full aspect-square max-w-lg mx-auto bg-dark flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center p-8">
                  ...
                  <div className="font-heading text-xl font-semibold text-white mb-2">Yıllık Deneyim</div>
                  <div className="font-body text-sm text-white/50">Atık Yönetimi & Çevre Mühendisliği</div>
