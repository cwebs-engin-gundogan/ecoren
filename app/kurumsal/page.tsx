        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {subPages.map((p) => {
              const Icon = p.icon;
              return (
                <Link key={p.href} href={p.href} className="group block bg-white border border-gray-100 p-10 hover:border-primary/50 hover:shadow-lg transition-all duration-300">
